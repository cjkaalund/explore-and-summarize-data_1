...
ggplot(aes(x=as.factor(year(CRASH_DATE))),data=dat_no2014)+
  geom_histogram()+
  xlab("Year")+
  ggtitle("Plot 1 - Histogram of crashes by year")
...
ggplot(aes(x=DAY,y=n),data=dat_by_day)+
  geom_boxplot()+
  ggtitle("Plot 4 - Crash frequency by day of the month")
```
...
ggplot(aes(x=WDAY,y=n),data=dat_by_wday)+
  geom_boxplot()+
  ggtitle("Plot 5 - Crash frequency by day of the week")
```
...
ggplot(aes(x=as.numeric(REPORT_DATE-CRASH_DATE)),data=dat_no2014)+
  ...
  ggtitle("Plot 7 - Histogram of difference between report and crash dates")
...
ggplot(aes(x=DCA,y=COUNT),data=pareto_dca)+
  ...
  ggtitle("Plot 9 - Bar chart of DCA, accident description, top 10")
```
...
ggplot(aes(x=TRAFFIC_CONTROL,y=COUNT),data=pareto_tc)+
  geom_bar(stat='identity')+
  theme(axis.text.x=element_text(angle=90,hjust=1))+
  ggtitle("Plot 10 - Bar chart of TRAFFIC_CONTROL, top 10")
```
...
ggplot(aes(x=as.factor(NO_VEHICLES)),data=dat)+
  geom_bar()+
  ggtitle("Plot 16 - Number of vehicles involved in the accident")
```
...
ggplot(aes(x=BAC),data=subset(dat,BAC>0))+
  geom_bar()+
  ggtitle("Plot 18 - Blood alcohol content, BAC>0 only shown")+
  theme(axis.text.x=element_text(angle=90,hjust=1))
```
...
ggmap(tasmap2)+
  ...
  guides(alpha=FALSE,size=FALSE)+
  facet_wrap(~HOUR)+
  ggtitle("Plot 24 - Density map of crashes in Hobart, faceted by HOUR")
```
...
ggmap(tasmap2)+
  ...
  guides(alpha=FALSE,size=FALSE)+
  facet_wrap(~WEEKDAY)+
  ggtitle("Plot 25 - Density of crashes, faceted by day of the week")
```
...
ggmap(tasmap2)+
  ...
  guides(alpha=FALSE,size=FALSE)+
  facet_wrap(~YEAR)+
  ggtitle("Plot 26 - Density of crashes in Hobart, faceted by year")
```
...
ggmap(tasmap2)+
  ...
  ggtitle("Plot 27 - Density map of crashes in Hobart,
          faceted by traffic control")
```
...
ggmap(tasmap2)+
  ...
  ggtitle("Plot 28 - Density map of crashes in Hobart, faceted by
          CRASH CODE")
```
...
ggmap(tasmap3)+
  ...
  facet_wrap(~SEVERITY)+
  guides(alpha=FALSE)+
  ggtitle("Plot 30 - Accident density on roundabout, facted by severity")
```
...
ggplot(aes(x=LIGHT_CONDITION),data=datsubset)+
  ...
  facet_grid(SEVERITY~.,scales="free_y")+
  theme(axis.text.x=element_text(angle=90,hjust=1))+
  ggtitle("Plot 36 - Crash frequency by LIGHT_CONDITION and SEVERITY")
```
...
ggplot(aes(x=CENTRELINE),data=datsubset)+
  ...
  facet_grid(SEVERITY~.,scales="free_y")+
  theme(axis.text.x=element_text(angle=90,hjust=1))+
  ggtitle("Plot 42 - Accident frequency against SEVERITY and CENTRELINE")

ggplot(aes(x=SPEED_ZONE),data=datsubset)+
  geom_histogram(stat='bin',binwidth=1)+
  facet_grid(CENTRELINE~.,scales="free_y")+
  theme(axis.text.x=element_text(angle=90,hjust=1))+
  ggtitle("Plot 43 - Accident frequency against SPEED_ZONE and CENTRELINE")
```
...
ggplot(aes(x=TRAFFIC_CONTROL),
  ...
  facet_grid(SEVERITY~.,scales="free_y")+
  theme(axis.text.x=element_text(angle=90,hjust=1))+
  ggtitle("Plot 45 - Accident frequency against TRAFFIC_CONTROL and SEVERITY")
```
...
ggplot(aes(x=CENTRELINE),data=subset(datsubset,CRASH_CODE%in%top10codes))+
  ...
  facet_grid(CRASH_CODE~.,scales="free_y")+
  theme(axis.text.x=element_text(angle=90,hjust=1))+
  ggtitle("Plot 46 - Accident frequency against CRASH_CODE and CENTRELINE")
```
...
ggplot(aes(x=SPEED_ZONE),data=subset(datsubset,CRASH_CODE%in%top10codes))+
  ...
  facet_grid(CRASH_CODE~.,scales="free_y")+
  theme(axis.text.x=element_text(angle=90,hjust=1))+
  ggtitle("Plot 47 - Accident frequency against CRASH_CODE and SPEED_ZONE")
...
ggplot(aes(x=SPEED_ZONE),data=datsubset)+
  ...
  theme(axis.text.x=element_text(angle=90,hjust=1))+
  ggtitle("Plot 49 - Accident frequency against SPEED_ZONE and SURFACE_TYPE")

ggplot(aes(x=SPEED_ZONE),data=datsubset)+
  geom_histogram()+
  facet_grid(LIGHT_CONDITION~.,scales="free_y")+
  theme(axis.text.x=element_text(angle=90,hjust=1))+
  ggtitle("Plot 50 - Accident frequency against SPEED_ZONE
          and LIGHT_CONDITION")
...
ggmap(tasmap3)+
  ...
  facet_wrap(~CRASH_CODE)+
  guides(alpha=FALSE)+
  ggtitle("Plot 56 - Accidents at roundabout by severity and CRASH_CODE")
```
...
ggplot(aes(x=HOUR,y=BAC),data=na.omit(datsubset))+
  ...
  ggtitle("Plot 60 - Median blood alcohol count (BAC) by hour and weekday,
          BAC=0 included")
```
...
ggplot(aes(x=as.factor(SPEED_ZONE_NUM),fill=LIGHT_CONDITION),data=dat6)+
  ...
  facet_grid(SURFACE_TYPE~.,scales="free_y")+
  ggtitle("Vehicle accidents in Tasmania 2004-2014 under different
